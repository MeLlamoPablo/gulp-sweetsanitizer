...
function test(options) {
	...
	}if (typeof options !== "undefined" &&  typeof options.nested !== "object") {
		return new Error("Parameter options.nested is not defined, or is not of type object");
	}if (typeof options !== "undefined" && typeof options.nested !== "undefined" &&  typeof options.nested.a !== "string") {
		return new Error("Parameter options.nested.a is not defined, or is not of type string");
	}if (typeof options !== "undefined" && typeof options.nested !== "undefined" &&  typeof options.nested.b !== "number") {
		return new Error("Parameter options.nested.b is not defined, or is not of type number");
	}if (typeof options !== "undefined" && typeof options.nested !== "undefined" &&  typeof options.nested.c !== "boolean") {
