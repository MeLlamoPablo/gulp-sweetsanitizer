 ...
 */
function test(a) {
	var error = (function(){if ( typeof a !== "undefined") {if ( typeof a === "undefined") {
		return new Error("Parameter a is not defined");
	}if (typeof a !== "undefined" &&  typeof a.a === "undefined") {
		return new Error("Parameter a.a is not defined");
	}if (typeof a !== "undefined" &&  typeof a.a !== "string") {
		return new Error("Parameter a.a is not defined, or is not of type string");
	}if (typeof a !== "undefined" &&  typeof a.b === "undefined") {
		return new Error("Parameter a.b is not defined");
	}if (typeof a !== "undefined" &&  typeof a.b !== "number") {
